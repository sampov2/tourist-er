...
IMPOSM_MAPPING=/tmp/mapping.json

POSTGIS_CONNECTION=postgis://docker:$(cat /run/secrets/POSTGRES_PASS)@localhost:5432/gis

$IMPOSM_DIR/imposm import -mapping $IMPOSM_MAPPING -read /tmp/input.pbf
$IMPOSM_DIR/imposm import -mapping $IMPOSM_MAPPING -write -connection $POSTGIS_CONNECTION 

$IMPOSM_DIR/imposm import -mapping $IMPOSM_MAPPING -connection $POSTGIS_CONNECTION -deployproduction
$IMPOSM_DIR/imposm import -mapping $IMPOSM_MAPPING -connection $POSTGIS_CONNECTION -removebackup
